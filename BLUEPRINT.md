...
### Overview
Vibes Plug is a customized plugin for Antigravity that houses high-performance custom skills designed for SaaS architectures, database management, premium UI/UX design, frontend performance optimization, and advanced SEO strategies.
...
### Ringkasan
Vibes Plug adalah plugin kustomisasi untuk Antigravity yang memuat berbagai kemampuan (*skills*) berkinerja tinggi. Dirancang khusus untuk arsitektur SaaS, manajemen database, desain UI/UX premium, optimasi performa frontend, dan strategi SEO lanjutan.

### Modul Skill
- **app-analyzer-optimizer**: Menganalisis secara mendalam arsitektur aplikasi, dependensi, konfigurasi performa, serta melakukan optimasi terarah yang selaras dengan skill vibes-plug yang aktif.
- **asisten-ramah**: Gaya asisten ramah agar selalu membalas dengan gaya bahasa yang hangat, sopan, dan menggunakan emoji.
